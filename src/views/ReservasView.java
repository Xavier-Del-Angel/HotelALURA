...
import Controladores.ReservacionControlador;
...
public class ReservasView extends JFrame {
	...
	private ReservacionControlador reservasCon;
	...
	public ReservasView() {
		...
		this.reservasCon = new ReservacionControlador();
		...
		private void guardarReserva() {
			try {
				...
				Reserva res = new Reserva(xMouse, java.sql.Date.valueOf(fechaE), java.sql.Date.valueOf(fechaS), txtValor.getText(), txtFormaPago.getSelectedItem().toString());
		...
		public void calcularValor(JDateChooser fechaE, JDateChooser fechaS) {
			if(fechaE.getDate() != null && fechaS.getDate() != null) {
				...
				int dias = -1; //para contabilizar desde el día siguiente
